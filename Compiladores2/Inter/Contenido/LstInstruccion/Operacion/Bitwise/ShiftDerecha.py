...
def shift_derecha(param1 : Valor, param2 : Valor):
    tipo_resultante = 0
    rst = 0
    ...
    if(param1.tipo==0):
        if param2.tipo==0:
            ...
            Ts.cargar_error(
                "Error En Shift Derecha Con Tipos: " + param1.dar_tipo_str() + "," + param2.dar_tipo_str(), 0,
                ((0, 0)))
            print("Error En shift Derecha Con Tipos: "+param1.dar_tipo_str()+","+param2.dar_tipo_str())
