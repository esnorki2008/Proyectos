...
def shift_izquierda(param1 : Valor, param2 : Valor):
    ...
    if(param1.tipo==0):
        if param2.tipo==0:
            ...
            print("Error En shift Izquierda Con Tipos: "+param1.dar_tipo_str()+","+param2.dar_tipo_str())
            Ts.cargar_error(
                "Error En Shift Izquierda Con Tipos: " + param1.dar_tipo_str() + "," + param2.dar_tipo_str(), 0,
                ((0, 0)))
    else:
        Ts.cargar_error(
            "Error En Shift Izquierda Con Tipos: " + param1.dar_tipo_str() + "," + param2.dar_tipo_str(), 0,
