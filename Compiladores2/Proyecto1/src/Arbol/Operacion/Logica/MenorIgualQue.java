...
public class MenorIgualQue extends Operacion{
    private Object Tipo1(Object Exec1, Object Exec2, int Tipo, TablaDeSimbolos Tabla) {
        ...
        switch (Tipo) {
            ...
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Comparar MenorIgualQue "+this.TipoATexto(1)+" Con "+this.TipoATexto(Tipo)));
                return null;
        }
    }
    ...
    private Object Tipo2(Object Exec1, Object Exec2, int Tipo, TablaDeSimbolos Tabla) {
        ...
        switch (Tipo) {
            ...
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Comparar MenorIgualQue "+this.TipoATexto(2)+" Con "+this.TipoATexto(Tipo)));
                return null;
        }
    }
    ...
    private Object Tipo3(Object Exec1, Object Exec2, int Tipo, TablaDeSimbolos Tabla) {
        ...
        switch (Tipo) {
            case 3:
                ...
                this.ValorTipo=0;
                return MenorIgualQue((String)Exec1, (String)Exec2);
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Comparar MenorIgualQue "+this.TipoATexto(3)+" Con "+this.TipoATexto(Tipo)));
                return null;
        }
    }
    ...
    public Object Operar(Object Valor1,int Tip1, Object Valor2,int Tip2, TablaDeSimbolos Tabla) {
        switch (Tip1) {
            ...
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Comparar MenorIgualQue De "+this.TipoATexto(Tip1)+" Con "+this.TipoATexto(Tip2)));
                return null;
        }
    }
}
