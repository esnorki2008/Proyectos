...
public class And extends Operacion{
    private Object Tipo0(Object Exec1, Object Exec2, int Tipo, TablaDeSimbolos Tabla) {
        ...
        switch (Tipo) {
            ...
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Hacer AND "+this.TipoATexto(3)+" Con "+this.TipoATexto(Tipo)));
                return null;
        }
    }
    ...
    public Object Operar(Object Valor1,int Tip1, Object Valor2,int Tip2, TablaDeSimbolos Tabla) {
        switch (Tip1) {
           case 0:
            ...
            default:
                Tabla.AgregarExcepcion(new Excepcion("No Se Puede Hacer AND "+this.TipoATexto(Tip1)+" Con "+this.TipoATexto(Tip2)));
                return null;
        }
    }
}
