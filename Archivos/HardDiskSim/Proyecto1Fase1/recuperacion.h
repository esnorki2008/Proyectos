...
public:
    ...
    void RecuEDIT(int Comienzo, const char *Path,const char*PathVirtual,bool Recursivo,int Tamanio,int PosiArchivo,IUG Inf);
    void RecuREM(int Comienzo, const char *Path,const char*PathVirtual,IUG Inf);
    void RecuMKFILE(int Comienzo, const char *Path,const char*PathVirtual,bool Recursivo,int Tamanio,int PosiArchivo,IUG Inf);
