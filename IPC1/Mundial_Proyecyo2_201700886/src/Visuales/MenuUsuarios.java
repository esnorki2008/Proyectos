...
public class MenuUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 0)));
        jPanel3.add(jLabel10);
        jLabel10.setBounds(200, 120, 180, 240);

        jLabel11.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 0)));
        jPanel3.add(jLabel11);
        jLabel11.setBounds(120, 120, 60, 150);

        jLabel12.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 0)));
        jPanel3.add(jLabel12);
        jLabel12.setBounds(120, 230, 60, 130);

        jButton11.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        jButton11.setText("Colocar");
        jButton11.setActionCommand("Colocar Estampa");
        ...
        jButton11.setBounds(410, 120, 140, 40);
        ...
        jButton12.setBounds(400, 190, 70, 30);
        ...
        jButton13.setBounds(480, 190, 70, 30);

        jLabel13.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        jLabel13.setText("Sobre Actual");
        jPanel3.add(jLabel13);
        jLabel13.setBounds(20, 30, 280, 40);

        jLabel14.setText("jLabel14");
        jPanel3.add(jLabel14);
        jLabel14.setBounds(410, 240, 140, 20);

        jLabel15.setText("jLabel15");
        jPanel3.add(jLabel15);
        jLabel15.setBounds(120, 370, 260, 15);
        ...
        jButton3.setText("Ver mi Colección");
        ...
        jButton3.setBounds(120, 100, 340, 210);
        ...
        jButton10.setBounds(60, 140, 130, 140);
        ...
        jTabbedPane1.setBounds(20, 0, 610, 440);
...
public static         String[][] Estampas = new String[10][5];
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        EnlaceUsuarios En = new EnlaceUsuarios();
        Sobres=En.UsE(IDUsuario);
       // JOptionPane.showMessageDialog(null,Sobres);
...
int ReporteUsuario1(int IDE){
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String[][] Datos = new String[EnlaceEstampas.EstampasTotales+10][2];
        
        for(int i=0;i<EnlaceEstampas.EstampasTotales;i++){
        ...
        for (int j = 0; j < EnlaceEstampas.EstampasTotales; j++) {

            for (int i = 0; i < EnlaceEstampas.EstampasTotales - 1; i++) {
        ...
        try{
            ...
            table.addCell("Jugador De La Estampa");
        ...
        EnlaceJugadores Jugadores = new EnlaceJugadores();
          ...
          nul=Repetidas.SiguienteNodo3(nul);
          IDEstampa=nul.IDEstampas;
          
          //jLabel10.setIcon(new ImageIcon(Estam.RutaImagen));
         ...
         // jLabel15.setText();
           ...
           for(int i=0;i<10;i++){
           NodoEstampas Estam;
          Estam=Estampa.SacarEstampa(Integer.parseInt(Datos[i][0]));  
               
               
           table.addCell(Equipos.DevolverEquipo(Estam.IDEquipo)+"   "+Jugadores.DevolverJugador(Estam.IDJugador));
           table.addCell(Datos[i][1]);
            ...
            celdaFinal.setColspan(2);
            table.addCell(celdaFinal);
            table.addCell("Usted Ha Abierto:  ");
            table.addCell(Sobres+"");
          ...
          Estam=Estampa.SacarEstampa(Integer.parseInt(Datos[i][0]));  
           ...
           table.addCell(Equipos.DevolverEquipo(Estam.IDEquipo));  
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        EnlaceEquipos Equipos = new EnlaceEquipos();
          ...
          nul=Repetidas.AnteriorNodo(nul);
          IDEstampa=nul.IDEstampas;
          NodoEstampas Estam;
          Estam=Estampa.SacarEstampa(nul.IDEstampas);
          jLabel10.setIcon(new ImageIcon(Estam.RutaImagen));
          jLabel14.setText(Equipos.DevolverEquipo(Estam.IDEquipo));
          jLabel15.setText(Jugadores.DevolverJugador(Estam.IDJugador));
          ...
          if (Estam.Rareza.equals("0")) {
            ...
            jLabel11.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 255, 51)));
